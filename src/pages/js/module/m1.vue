<template>
  <div class="post">
    ...
    <p>. splice(开始，0，元素...)</p>
    <p>2.中间插入</p>
    <p>arr.splice(5,0,'a','b'),</p>
    <p>alert(arr);</p>
    <h5>. 替换</h5>
    <p>3 . arr.splice(1,2,'a','b');</p>
    <p>alert (arr);</p>
    <h4> 15.知识点</h4>
    <p>. 函数可变参数：arguments</p> 
    <p>. 函数返回值：return</p>
    <p>. 数组常用的方法</p>
    <p>. this的用法</p>
    <p>. 动态绑定事件处理函数</p>
    <h4>创建‘插入和删除元素</h4>
    <p>. 创建dom元素</p>
    <p>. create elemen(标签名)   创建一个节点</p>
    <p>. append child(节点)      追加一个节点</p>
    <h5>.插入元素 </h5>
    <p>. insertbefore(节点，原有的节点)  在已有元素前插入</p>
    <h5>. 删除dom元素</h5>
    <p>. remove吃了点（节点）删除一个节点</p>
    <p></p>
    <p></p>
    <p></p>
    <p></p>
